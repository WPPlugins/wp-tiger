...
class SmackWPVT {
	...
	public static function plugin_row($plugin_name) {
		...
		echo '</tr><tr class="plugin-update-tr active"><td colspan="3" class="plugin-update colspanchange"><div class="update-message notice inline notice-warning notice-alt" > <p>WP Tiger is now <a href="https://wordpress.org/plugins/wp-leads-builder-any-crm/" target="blank">Leads Builder For Any CRM</a> for advanced features. <a onclick="deactivate_wp_tig()"> Proceed </a> to remove old files of WP Tiger and use Leads Builder For Any CRM </p> </div></td>';
		}
		else{
			echo '</tr><tr class="plugin-update-tr active"><td colspan="3" class="plugin-update colspanchange"><div class="update-message notice inline notice-warning notice-alt" > <p>WP Tiger is now <a href="https://wordpress.org/plugins/wp-leads-builder-any-crm/" target="blank">Leads Builder For Any CRM</a> for advanced features. <a href="admin.php?page=wp-tiger"> Proceed </a> to install Leads Builder For Any CRM </p> </div></td>';
		}
