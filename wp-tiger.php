...
function wptiger_activation_redirect( $plugin ) {
        ...
        exit( wp_redirect( admin_url( 'admin.php?page=wp-tiger' ) ) );
...
{
   deactivate_plugins('wp-tiger/wp-tiger.php');
   $dea = array('wp-tiger/wp-tiger.php');
   delete_plugins($dea);
   echo "success";
   die();
}
...
<h1 style="text-align: center;padding-bottom: 30px">WP Tiger is now Leads builder for any CRM</h1> 

<p style="font-size: 17px;  word-spacing: 3px; padding-bottom: 30px">For easy maintenance we merged couple of plugins and more advanced features together. So you can enjoy all benefits in WP Leads builder for any CRM plugin. You can access whole Vtiger integration and features via admin side bar menu under 
Leads Builder For Any CRM >> CRM Configuration >> Choose VtigerCRM from drop down.
   </p>

		<div class="updated notice" style="font-size: 18px">
        	<p style="font-size: 17px;word-spacing: 3px;">
        		WP Leads builder for any CRM (includes WP Tiger features) has been successfully installed and you can click proceed to remove old files and folder. </p>
...
<p style="font-size: 17px;  word-spacing: 3px;padding-bottom: 30px">For easy maintenance we merged couple of plugins and more advanced features together. So to enjoy benefits of WP Leads builder for any CRM plugin Vtiger features please follow one of the method below.
   </p>
    <div class="error settings-error notice">
<p style="font-size: 17px;word-spacing: 3px;">
<strong>
  Cannot proceed. WP Tiger requires the following plugin to be installed or updated: <a href="https://wordpress.org/plugins/wp-leads-builder-any-crm/" target="blank" style="text-decoration: none;">Leads Builder For Any CRM</a> </strong>
  </p>
